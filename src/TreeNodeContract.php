...
interface TreeNodeContract {
     ...
     * 如果实体是 merchant 则返回的编号为 merchant->id + 800000000
     * 如果实体是 agent 则返回的编号为 agent->id + 900000000
     */
     ...
     * 如果父实体是 platform 则返回的编号为 platform_id + 100000000
     ...
     * 如果父实体是 merchant 则返回的编号为 merchant_id + 800000000
